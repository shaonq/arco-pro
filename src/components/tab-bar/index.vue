        ...
        <div class="tab-bar-scroll">
          <div class="tags-wrap">
            <span
              ...
              :key="tag.fullPath"
              class="arco-tag arco-tag-checked"
              :class="{ 'link-activated': tag.fullPath === $route.fullPath }"
              @click="goto(tag)"
            >
              <span class="tag-link"> {{ $t(tag.title) }} </span>
              <span class="arco-icon-hover arco-tag-icon-hover arco-icon-hover-size-medium arco-tag-close-btn" @click.stop="tagClose(tag, index)">
                <icon-close />
              </span>
            </span>
          </div>
